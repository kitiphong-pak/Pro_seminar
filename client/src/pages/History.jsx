...
function History() {
  ...
  if (!historyData) return (
    <div className="min-h-screen bg-[#f3f1ec] flex flex-col">
      ...
      <div className="h-28 bg-[#e8dfd6] animate-pulse" />
  ...
  return (
    <div className="min-h-screen bg-[#f3f1ec] flex flex-col">
      ...
      {/* HERO */}
      <header className="relative isolate bg-[#e8dfd6] pt-4 overflow-hidden">
        ...
        <div className="relative mx-auto max-w-6xl px-4 md:px-8 py-10 text-center">
          <span className="inline-block rounded-full bg-[#7b4b29]/10 text-[#7b4b29] text-xs font-medium px-4 py-1 mb-3 tracking-widest uppercase" data-aos="fade-down">
            Coffee History
          </span>
          <h1 className="text-3xl lg:text-5xl font-extrabold text-[#3d2010] leading-tight" data-aos="fade-down" data-aos-delay="50">
            ประวัติศาสตร์ของกาแฟ
          </h1>
          <p className="mt-3 text-[#2a1c14]/70 max-w-xl mx-auto" data-aos="fade-down" data-aos-delay="100">
      ...
      <main className="flex-1 mb-4">
        ...
        <div className="relative overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-[#f3f1ec] via-transparent to-transparent" />
        </div>
        ...
        <section id="origins" className="mx-auto max-w-6xl px-4 md:px-8 py-12">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-7 order-2 lg:order-1" data-aos="fade-right">
              <div className="border-l-4 border-[#7b4b29]/40 pl-5 mb-4">
                <p className="text-xs uppercase tracking-widest text-[#7b4b29]/60">Chapter 01</p>
                <h2 className="text-xl md:text-2xl font-bold text-[#3d2010] mt-1">{origins.title}</h2>
              </div>
              <p className="text-[#2a1c14]/80 leading-8 indent-8 bg-white/60 rounded-2xl p-5 shadow-sm">
                {origins.content}
              </p>
            </div>
            <figure className="lg:col-span-5 order-1 lg:order-2" data-aos="fade-left">
              ...
              <figcaption className="mt-2 text-xs text-[#2a1c14]/50 text-center italic">{origins.figcaption}</figcaption>
            </figure>
          </div>
        </section>
        ...
        <div className="relative overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-[#f3f1ec] via-transparent to-transparent" />
          <div className="absolute inset-0 bg-gradient-to-b from-[#f3f1ec] via-transparent to-transparent" />
        </div>
        ...
        <section id="arab" className="mx-auto max-w-6xl px-4 md:px-8 py-12">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-7 order-2 lg:order-1" data-aos="fade-left">
              <div className="border-l-4 border-[#7b4b29]/40 pl-5 mb-4">
                <p className="text-xs uppercase tracking-widest text-[#7b4b29]/60">Chapter 02</p>
                <h2 className="text-xl md:text-2xl font-bold text-[#3d2010] mt-1">{arab.title}</h2>
              </div>
              <p className="text-[#2a1c14]/80 leading-8 indent-8 bg-white/60 rounded-2xl p-5 shadow-sm">
                {arab.content}
              </p>
            ...
            <figure className="lg:col-span-5 order-1 lg:order-2" data-aos="fade-right">
              ...
              <figcaption className="mt-2 text-xs text-[#2a1c14]/50 text-center italic">{arab.figcaption}</figcaption>
            </figure>
          </div>
        </section>
        ...
        <section id="firstcafe" className="mx-auto max-w-6xl px-4 py-8">
          <div className="flex flex-col lg:flex-row items-center gap-8 rounded-3xl bg-gradient-to-br from-[#f7efe6] to-[#ede0d0] shadow-md ring-1 ring-[#7b4b29]/10 p-8 md:p-12" data-aos="fade-up">
            <div className="lg:w-3/5">
              <div className="border-l-4 border-[#7b4b29] pl-5 mb-4">
                <p className="text-xs uppercase tracking-widest text-[#7b4b29]/60">Chapter 03</p>
                <h2 className="text-xl md:text-2xl font-bold text-[#3d2010] mt-1">{firstcafe.title}</h2>
              </div>
              <p className="text-[#2a1c14]/80 leading-8">{firstcafe.content}</p>
            </div>
        ...
        <section id="europe" className="mx-auto max-w-6xl px-4 md:px-8 py-12">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-7 order-2 lg:order-1" data-aos="fade-right">
              <div className="border-l-4 border-[#7b4b29]/40 pl-5 mb-4">
                <p className="text-xs uppercase tracking-widest text-[#7b4b29]/60">Chapter 04</p>
                <h2 className="text-xl md:text-2xl font-bold text-[#3d2010] mt-1">{europe.title}</h2>
              </div>
              <p className="text-[#2a1c14]/80 leading-8 indent-8 bg-white/60 rounded-2xl p-5 shadow-sm">
                {europe.content}
              </p>
            ...
            <figure className="lg:col-span-5 order-1 lg:order-2" data-aos="fade-left">
              ...
              <figcaption className="mt-2 text-xs text-[#2a1c14]/50 text-center italic">{europe.figcaption}</figcaption>
            </figure>
          </div>
        </section>
        ...
        <div className="text-center mb-8 mt-14 px-4" data-aos="fade-up">
          <span className="inline-block rounded-full bg-[#7b4b29]/10 text-[#7b4b29] text-xs font-medium px-4 py-1 mb-3 tracking-widest uppercase">Origins</span>
          <h2 className="text-2xl lg:text-3xl font-extrabold text-[#3d2010]">แหล่งกำเนิดกาแฟแต่ละทวีป</h2>
              ...
              {historyData.continents.map((c, idx) => {
                ...
                return (
                  <div key={c.name} className="relative" data-aos={isLeft ? "fade-right" : "fade-left"}>
                    {/* จุด timeline */}
                    <div className="hidden md:flex absolute left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 z-10 h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-[#7b4b29] to-[#c47a3a] shadow-lg ring-4 ring-[#f3f1ec]">
                    ...
                    <div className={`md:grid md:grid-cols-2 md:gap-10 items-center ${isLeft ? "" : "md:[&>*:first-child]:order-2 md:[&>*:last-child]:order-1"}`}>
                      ...
                      <div className={isLeft ? "md:pl-6" : "md:pr-6"}>
                        <div className="bg-white rounded-2xl shadow-md ring-1 ring-black/5 p-6 hover:shadow-lg transition-shadow duration-300">
                          {/* mobile dot */}
                          ...
                          <h3 className="text-xl font-bold text-[#3d2010] mb-3 flex items-center gap-2">
                            <span className="h-3 w-3 rounded-full bg-gradient-to-br from-[#7b4b29] to-[#c47a3a] inline-block shrink-0" />
                            {c.name}
                          </h3>
                          <p className="text-gray-600 leading-relaxed text-sm">{c.content}</p>
                        </div>
                      </div>
                    </div>
                  </div>
